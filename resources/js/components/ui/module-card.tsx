        ...
        <>
            ...
            <Dialog open={isEditing} onOpenChange={setIsEditing}>
                <DialogContent className="max-w-md">
                    <DialogHeader>
                        <DialogTitle>Edit Add-On Price - {module.alias}</DialogTitle>
                        <DialogDescription>
                            Update module details including name, image, and pricing.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                        <div>
                            <Label htmlFor="module_name">Add-On Name</Label>
                            <Input
                                id="module_name"
                                type="text"
                        ...
                        <div>
                            <Label htmlFor="module_image">Add-On Image</Label>
                            <Input
                                id="module_image"
                                type="file"
                                accept="image/*"
