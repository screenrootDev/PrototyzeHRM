  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="bg-white dark:bg-gray-950 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm border-r border-default-200"
          style={style}
        >
          {children}
        </div>
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-zinc-50 dark:bg-zinc-950 relative flex min-h-svh min-w-0 flex-1 flex-col overflow-x-hidden",
