      ...
      <Popover open={open} onOpenChange={setOpen} modal={false}>
        <PopoverTrigger asChild>
          ...
          >
            ...
            {value && startDate && (mode === 'single' || endDate) ? formatValue(startDate, endDate) : (placeholder || (mode === 'single' ? 'Select date time' : 'Select date time range'))}
          </Button>
        </PopoverTrigger>
        <PopoverContent 
        ...
        >
          <div className="datetime-range-wrapper">
            {mode === 'single' ? (
              <div className="p-3">
                <div className="text-sm font-medium mb-2 text-center">Select Date & Time</div>
                <DatePicker
                  selected={startDate}
              ...
              <div className="flex">
                <div className="p-3 border-r border-border">
                  <div className="text-sm font-medium mb-2 text-center">Start Date & Time</div>
                  <DatePicker
                    selected={startDate}
                    onChange={handleStartDateChange}
                    showTimeSelect
                ...
                <div className="p-3">
                  <div className="text-sm font-medium mb-2 text-center">End Date & Time</div>
                  <DatePicker
                    selected={endDate}
