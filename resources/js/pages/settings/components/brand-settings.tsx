...
export const getBrandSettings = (
    ...
    try {
      ...
      return {
        ...
        titleText:
          ...
          DEFAULT_BRAND_SETTINGS.titleText,
        footerText:
          parsedBrand.footerText ||
          userSettings?.footerText ||
          DEFAULT_BRAND_SETTINGS.footerText,
        companyMobile:
          parsedBrand.companyMobile ||
          userSettings?.companyMobile ||
          DEFAULT_BRAND_SETTINGS.companyMobile,
        themeColor: parsedTheme.themeColor || DEFAULT_BRAND_SETTINGS.themeColor,
        customColor:
          parsedTheme.customColor || DEFAULT_BRAND_SETTINGS.customColor,
        sidebarVariant:
  ...
  if (userSettings) {
    return {
      ...
      companyMobile:
        userSettings.companyMobile || DEFAULT_BRAND_SETTINGS.companyMobile,
      themeColor:
        (userSettings.themeColor as ThemeColor) ||
        DEFAULT_BRAND_SETTINGS.themeColor,
      customColor:
        userSettings.customColor || DEFAULT_BRAND_SETTINGS.customColor,
      sidebarVariant:
...
export default function BrandSettings({ settings }: BrandSettingsProps) {
  ...
  const [brandSettings, setBrandSettings] = useState<BrandSettings>(() =>
    getBrandSettings(currentGlobalSettings || settings, currentGlobalSettings),
  );
  ...
  useEffect(() => {
    ...
    const newBrandSettings = getBrandSettings(
                        ...
                        <img
                          ...
                          onError={(e) => {
                            (e.currentTarget as HTMLImageElement).src =
                              "images/default/image-not-found.jpg";
                          }}
                        />
                      ) : (
                  ...
                  <div className="grid grid-cols-6 gap-2">
                    {Object.entries({
                      ...
                      <Button
                        ...
                        type="button"
                        variant={
                          brandSettings.themeColor === color
                            ? "default"
                            : "outline"
                        }
                        ...
                        onClick={() =>
                          handleThemeColorChange(color as ThemeColor)
                        }
                      >
                        <span
                      ...
                      <div className="flex gap-2">
                        <div className="relative">
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor: brandSettings.customColor,
                            }}
                          />
                        </div>
                        <Input
