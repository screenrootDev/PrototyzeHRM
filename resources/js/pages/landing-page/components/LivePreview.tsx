...
export default function LivePreview({ data, activeSection }: LivePreviewProps) {
  ...
  const getSectionData = (key: string) => {
    return (
      data.config_sections?.sections?.find(
            ...
            <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border dark:border-gray-600">
              ...
              <div className="flex gap-1">
                <div
                  ...
                  style={{
                    backgroundColor:
                      data.config_sections?.theme?.primary_color || "#3b82f6",
                    color: "white",
                  }}
                >
              ...
              <div className="grid grid-cols-2 gap-1">
                {(featuresData.features_list || [])
                  ...
                  .map((feature: any, index: number) => (
                    <div
                      key={index}
                      className="p-1 bg-white dark:bg-gray-800 rounded text-xs dark:text-gray-300"
                    >
  ...
  return (
    <div className="sticky top-20 space-y-6">
      {/* Completion Status */}
      <div
        className="bg-gradient-to-br rounded-xl p-6 shadow-sm border"
        style={{
        ...
        <div className="flex gap-3">
          ...
          <div className="flex flex-col items-center gap-1">
            <div
              ...
              style={{
                backgroundColor:
                  data.config_sections?.theme?.secondary_color || "#8b5cf6",
              }}
            ></div>
            <span className="text-xs text-gray-500 dark:text-gray-400">
              {t("Secondary")}
          ...
          <div className="flex flex-col items-center gap-1">
            <div
              ...
              style={{
                backgroundColor:
                  data.config_sections?.theme?.accent_color || "#0075BD",
              }}
            ></div>
            <span className="text-xs text-gray-500 dark:text-gray-400">
              {t("Accent")}
