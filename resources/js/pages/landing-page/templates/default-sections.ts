export const defaultLandingPageSections = {
  sections: [
      ...
      features_list: [
        {
          ...
          description:
            "Centralized profiles with personal, job, and document details.",
          icon: "users",
        },
        {
          title: "Payroll Automation",
          description:
            "Generate accurate payslips with tax, allowances, and deductions.",
          icon: "dollar-sign",
        },
        {
        ...
        },
        {
          ...
          description:
            "Streamline hiring with applicant tracking and digital onboarding.",
        },
...

        {
          ...
          description:
            "Get actionable insights on workforce productivity and HR metrics.",
        },
      ],
    },

    {
      ...
      screenshots_list: [
        ...
        },
        {
          ...
          title: "Employee Management",
          description:
            "Centralized employee profiles with personal details, documents, and job history.",
        },
        {
          ...
          description:
            "Automated payroll processing with tax calculations, allowances, and downloadable payslips.",
        },
        {
          ...
          description:
            "Easily apply, approve, and track employee leave requests with proper workflows and policies.",
        },
        {
          ...
          description:
            "Monitor employee check-ins, check-outs, and shifts with automated attendance logs.",
        },
        {
...

    {
      ...
      reasons: [
        ...
        },
        {
          ...
          description:
            "Automate repetitive HR tasks to focus on strategic decision-making.",
          icon: "clock",
        },
        {
          icon: "bar-chart",
          ...
          description:
            "Make informed decisions with advanced analytics and reports.",
        },
        {
          icon: "shield",
          title: "Secure & Reliable",
          description:
            "Keep sensitive HR data safe with enterprise-grade security.",
        },
      ],
      stats: [
    ...
    // },
    {
      ...
      story_title:
        "We are passionate about simplifying HR management for businesses of all sizes.",
      story_content:
        "Founded by HR and tech enthusiasts, HRMGo was created to replace cumbersome spreadsheets and manual processes with a modern, all-in-one HR platform.",
      image: "",
    ...
    },
    {
      ...
      cta_description:
        "We're always looking for talented individuals to shape the future of HR management.",
      ...
      testimonials: [
        {
          ...
          content:
            "HRMGo has made managing employee records and attendance effortless. Our HR team saves hours every week!",
          rating: 5,
        },
        {
          name: "Robert Smith",
          ...
          content:
            "The payroll automation is incredibly accurate and easy to use. No more manual calculations or errors!",
          rating: 5,
        },
        {
          name: "Maria Davis",
          ...
          content:
            "From recruitment to performance management, HRMGo covers everything we need in one platform.",
          rating: 5,
        },
        {
          name: "David Lee",
          ...
          content:
            "Recruitment and onboarding have never been smoother. HRMGo’s platform is intuitive and efficient.",
          rating: 5,
        },
        {
          name: "Samantha Green",
          ...
          content:
            "Payroll processing is now quick and error-free thanks to HRMGo. It has transformed our monthly workflow.",
          rating: 5,
        },
        {
          name: "Michael Brown",
          ...
          content:
            "The performance management module helps us track employee goals and progress effortlessly.",
          rating: 5,
        },
      ],
    },
      ...
      faqs: [
        {
          ...
          answer:
            "HRM SaaS is an all-in-one HR platform that helps you manage employees, payroll, attendance, recruitment, and performance efficiently.",
        },
        {
          question: "Can I automate payroll and leave tracking?",
          answer:
            "Yes! HRM SaaS allows you to automate payroll calculations, generate payslips, and track employee leaves and attendance seamlessly.",
        },
        {
          question: "Is my employee data secure?",
          answer:
            "Absolutely. HRM SaaS uses enterprise-grade security measures to keep all sensitive HR data safe and confidential.",
        },
        {
          question: "Can I manage recruitment and onboarding?",
          answer:
            "Yes, HRM SaaS provides applicant tracking, interview management, and digital onboarding tools to simplify hiring.",
        },
        {
          question: "Does HRM SaaS support performance evaluations?",
          answer:
            "Yes, you can set goals, track KPIs, and run performance reviews directly within the platform.",
        },
        {
          question: "Can HRM SaaS generate HR reports?",
          answer:
            "HRM offers advanced analytics and reporting features to give insights on attendance, payroll, and workforce performance.",
        },
        {
          question: "What plans are available and can I upgrade anytime?",
          answer:
            "We offer flexible plans for different team sizes. You can start with the free plan and upgrade as your organization grows.",
        },
      ],
    },
    {
      ...
      benefits: [
        ...
        },
        {
          ...
          title: "HR Insights",
          description:
            "Get tips and best practices to optimize your HR operations.",
        },
        {
          icon: "📊",
          title: "Reports & Trends",
          description:
            "Receive analytics insights and industry trends directly to your inbox.",
        },
      ],
    },
    {
      ...
      info_description:
        "We're here to help and answer any questions you might have about managing your HR processes efficiently.",
      layout: "split",
      background_color: "#f9fafb",
    },
    {
      key: "footer",
      description:
        "Simplifying HR management with an all-in-one modern platform.",
      newsletter_title: "Stay Updated",
      newsletter_subtitle:
        "Join our newsletter for HR tips and product updates",
      links: {
        product: [
  ...
  seo: {
    ...
    meta_description:
      "Simplify employee management, payroll, attendance, recruitment, and performance with HRM, a modern HR SaaS platform.",
    meta_keywords:
      "HR software, HRM, employee management, payroll, attendance tracking, recruitment, performance management",
  },
  custom_css: "",
  custom_js: "",
  section_order: [
