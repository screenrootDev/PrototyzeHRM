...
export default function TemplatesSection({
  ...
  const categories = [
    "all",
    ...new Set(availableTemplates.map((template) => template.category)),
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <select
                ...
                onChange={(e) =>
                  updateSectionData("templates", { layout: e.target.value })
                }
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  type="color"
                  value={
                    getSectionData("templates").background_color || "#f8fafc"
                  }
                  onChange={(e) =>
                    updateSectionData("templates", {
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {visibleTemplates.map((template) => {
              ...
              const isSelected = templatesList.some(
                (t: any) =>
                  t && t.name && template.name && t.name === template.name,
              );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-3">
            ...
            <Input
              ...
              onChange={(e) =>
                updateSectionData("templates", { cta_link: e.target.value })
              }
