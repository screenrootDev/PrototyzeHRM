...
export default function LandingPageSettings() {
  ...
  const [activeTab, setActiveTab] = useState<
    "setup" | "layout" | "content" | "social" | "engagement"
  >("setup");
  ...
  const { data, setData, post, processing, errors } = useForm<Settings>({
    ...
    config_sections:
      ...
      settings.config_sections.sections.length > 0
        ? {
            sections: settings.config_sections.sections || [],
            theme:
              settings.config_sections.theme ||
              defaultLandingPageSections.theme,
            seo: settings.config_sections.seo || defaultLandingPageSections.seo,
            section_order:
              settings.config_sections.section_order ||
              defaultLandingPageSections.section_order,
            section_visibility:
              settings.config_sections.section_visibility ||
              defaultLandingPageSections.section_visibility,
          }
  ...
  const getSectionData = (key: string) => {
    return (
      data.config_sections?.sections?.find((section) => section.key === key) ||
      {}
    );
  };
            ...
            {activeSection === "general" && (
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                  ...
                  <div
                    className="mt-6 p-4 bg-gradient-to-r rounded-lg border"
                    style={{
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <Input
                            ...
                            type="color"
                            value={
                              data.config_sections?.theme?.primary_color ||
                              "#3b82f6"
                            }
                            onChange={(e) =>
                              updateThemeData({ primary_color: e.target.value })
                            }
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <Input
                            ...
                            type="color"
                            value={
                              data.config_sections?.theme?.secondary_color ||
                              "#8b5cf6"
                            }
                            onChange={(e) =>
                              updateThemeData({
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <Input
                            ...
                            type="color"
                            value={
                              data.config_sections?.theme?.accent_color ||
                              "#0075BD"
                            }
                            onChange={(e) =>
                              updateThemeData({ accent_color: e.target.value })
                            }
                            className="w-16 h-10 p-1"
                          />
                          <Input
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("header", checked)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          checked={
                            getSectionData("header").transparent || false
                          }
                          onCheckedChange={(checked) =>
                            updateSectionData("header", {
                              transparent: checked,
                            })
                          }
                        />
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          type="color"
                          value={
                            getSectionData("header").background_color ||
                            "#ffffff"
                          }
                          onChange={(e) =>
                            updateSectionData("header", {
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          type="color"
                          value={
                            getSectionData("header").text_color || "#1f2937"
                          }
                          onChange={(e) =>
                            updateSectionData("header", {
                    ...
                    <div className="space-y-3">
                      ...
                      <select
                        ...
                        value={
                          getSectionData("header").button_style || "gradient"
                        }
                        onChange={(e) =>
                          updateSectionData("header", {
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("hero", checked)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateSectionData("hero", { layout: e.target.value })
                        }
                        className="w-full p-2 border border-gray-300 rounded-md"
                      >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-3">
                        ...
                        <Input
                          ...
                          value={
                            getSectionData("hero").primary_button_text || ""
                          }
                          onChange={(e) =>
                            updateSectionData("hero", {
                      ...
                      <div className="space-y-3">
                        ...
                        <Input
                          ...
                          value={
                            getSectionData("hero").secondary_button_text || ""
                          }
                          onChange={(e) =>
                            updateSectionData("hero", {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          type="color"
                          value={
                            getSectionData("hero").background_color || "#f8fafc"
                          }
                          onChange={(e) =>
                            updateSectionData("hero", {
                              background_color: e.target.value,
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            updateSectionData("hero", { overlay: checked })
                          }
                        />
                      </div>
                      <p className="text-xs text-muted-foreground">
                    ...
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        value={
                          getSectionData("hero").overlay_color ||
                          "rgba(0,0,0,0.5)"
                        }
                        onChange={(e) =>
                          updateSectionData("hero", {
            ...
            {activeSection === "screenshots" && (
              <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("screenshots", checked)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData("screenshots").screenshots_list || []).map(
                      (screenshot, index) => (
                        <div
                          key={index}
                              ...
                              <MediaPicker
                                ...
                                onChange={(value) => {
                                  ...
                                  newScreenshots[index] = {
                                    ...newScreenshots[index],
                                    src: convertToRelativePath(value),
                                  };
                                  updateSectionData("screenshots", {
                                    screenshots_list: newScreenshots,
                                  });
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const newScreenshots = [
                          ...(getSectionData("screenshots").screenshots_list ||
                            []),
            ...
            {activeSection === "whychooseus" && (
              <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("why_choose_us", checked)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateSectionData("why_choose_us", {
                            title: e.target.value,
                          })
                        }
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData("why_choose_us").reasons || []).map(
                      (reason, index) => (
                        <div
                          key={index}
                          className="bg-gray-50 border border-gray-200 rounded-xl p-5"
                        >
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const newReasons = (
                                  getSectionData("why_choose_us").reasons || []
                                ).filter((_, i) => i !== index);
                                updateSectionData("why_choose_us", {
                                  reasons: newReasons,
                                });
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 gap-4 mb-6">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        value={
                          getSectionData("why_choose_us").stats_title || ""
                        }
                        onChange={(e) =>
                          updateSectionData("why_choose_us", {
                    ...
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        value={
                          getSectionData("why_choose_us").stats_subtitle || ""
                        }
                        onChange={(e) =>
                          updateSectionData("why_choose_us", {
                  ...
                  <div className="space-y-4">
                    {(getSectionData("why_choose_us").stats || []).map(
                      (stat, index) => (
                        <div
                          key={index}
                        ...
                        >
                          <div className="space-y-3">
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                const newStats = [
                                  ...(getSectionData("why_choose_us").stats ||
                                    []),
                                ];
                                newStats[index] = {
                                  ...newStats[index],
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        value={
                          getSectionData("why_choose_us").cta_subtitle || ""
                        }
                        onChange={(e) =>
                          updateSectionData("why_choose_us", {
            ...
            {activeSection === "team" && (
              <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("team", checked)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData("team").members || []).map(
                      (member, index) => (
                        <div
                          key={index}
                          className="bg-gray-50 border border-gray-200 rounded-xl p-5"
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("testimonials", checked)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    {(getSectionData("testimonials").trust_stats || []).map(
                      (stat, index) => (
                        <div
                          key={index}
                          className="grid grid-cols-3 gap-4 p-4 border rounded-lg"
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const newStats = [
                          ...(getSectionData("testimonials").trust_stats || []),
                          { value: "", label: "", color: "blue" },
                        ];
                        updateSectionData("testimonials", {
                          trust_stats: newStats,
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData("testimonials").testimonials || []).map(
                      (testimonial, index) => (
                        <div
                          key={index}
                          className="bg-gray-50 border border-gray-200 rounded-xl p-5"
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const newTestimonials = (
                                  getSectionData("testimonials").testimonials ||
                                  []
                                ).filter((_, i) => i !== index);
                                updateSectionData("testimonials", {
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("plans", checked)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("faq", checked)
                        }
                      />
                    </div>
                  </div>
            ...
            {activeSection === "newsletter" && (
              <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("newsletter", checked)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData("newsletter").benefits || []).map(
                      (benefit, index) => (
                        <div
                          key={index}
                          className="bg-gray-50 border border-gray-200 rounded-xl p-5"
                        >
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const newBenefits = (
                                  getSectionData("newsletter").benefits || []
                                ).filter((_, i) => i !== index);
                                updateSectionData("newsletter", {
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="space-y-3">
                              <Label htmlFor={`benefit_${index}_title`}>
                                Title
                              </Label>
                              <Input
            ...
            {activeSection === "contact" && (
              <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("contact", checked)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData("contact").faqs || []).map(
                      (faq, index) => (
                        <div
                          key={index}
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            <div className="space-y-3">
                              <Label htmlFor={`contact_faq_${index}_question`}>
                                Question
                              </Label>
                              <Input
                            ...
                            <div className="space-y-3">
                              <Label htmlFor={`contact_faq_${index}_answer`}>
                                Answer
                              </Label>
                              <Textarea
            ...
            {activeSection === "footer" && (
              <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateSectionVisibility("footer", checked)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        value={
                          getSectionData("footer").newsletter_subtitle || ""
                        }
                        onChange={(e) =>
                          updateSectionData("footer", {
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData("footer").social_links || []).map(
                      (social, index) => (
                        <div
                          key={index}
                          className="bg-gray-50 border border-gray-200 rounded-xl p-5"
                        >
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const newSocials = (
                                  getSectionData("footer").social_links || []
                                ).filter((_, i) => i !== index);
                                updateSectionData("footer", {
                    ...
                    {["product", "company", "support", "legal"].map(
                      (category) => (
                        <div key={category} className="space-y-4">
                          ...
                          {(
                            getSectionData("footer").links?.[category] || []
                            ...
                            >
                              <div className="space-y-3">
                                ...
                                <Input
                                  ...
                                  onChange={(e) => {
                                    const newLinks = {
                                      ...getSectionData("footer").links,
                                    };
                                    if (!newLinks[category])
                                      newLinks[category] = [];
                                    newLinks[category][index] = {
                                      ...newLinks[category][index],
                                      name: e.target.value,
                                    };
                                    updateSectionData("footer", {
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          onChange={(e) =>
                            updateThemeData({ secondary_color: e.target.value })
                          }
                          className="w-16 h-10 p-1"
                        />
                        <Input
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        id="meta_description"
                        value={
                          data.config_sections?.seo?.meta_description || ""
                        }
                        onChange={(e) =>
