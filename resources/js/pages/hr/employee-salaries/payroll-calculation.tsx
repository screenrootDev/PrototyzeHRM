...
export default function PayrollCalculation() {
  ...
  const breadcrumbs = [
    ...
    { title: 'Employee Salaries', href: route('hr.employee-salaries.index') },
    { title: 'Payroll Calculation' }
  ];

  const pageActions = [
    {
      label: 'Back to Salaries',
  ...
  return (
    <PageTemplate
      title={`${'Payroll Calculation'} - ${employeeSalary.employee.name}`}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  {'Payroll Calculation for'} {currentMonth ? new Date(currentMonth).toLocaleDateString('en-US', { year: 'numeric', month: 'long' }) : '-'}
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-blue-600">{'Basic Salary'}</span>
              </div>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-purple-600">{'Net Salary'}</span>
              </div>
        ...
        {loading && (
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-2 text-gray-600 dark:text-gray-400">{'Loading payroll data...'}</span>
            </div>
          </div>
        )}
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">{'Paid Leave Days'}</p>
              </div>
               <div className="text-center">
                <p className="text-2xl font-bold text-indigo-600">{attendanceSummary.unpaid_leave_days || 0}</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">{'Total Unpaid Leave'}</p>
        ...
        {!loading && (
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-gray-700 dark:text-gray-300">{'Per Day Salary'}</span>
                <span className="font-mono text-blue-600">{window.appSettings?.formatCurrency(payrollCalculation.per_day_salary || 0)}</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-gray-700 dark:text-gray-300">{'Unpaid Leave Deduction'} ({attendanceSummary.unpaid_leave_from_leave || 0} days)</span>
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-gray-700 dark:text-gray-300">{'Half Day Deduction'} ({attendanceSummary.half_days} × 0.5)</span>
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-gray-700 dark:text-gray-300">{'Absent Day Deduction'} ({attendanceSummary.absent_days} days)</span>
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-gray-700 dark:text-gray-300">{'Overtime Amount'}</span>
            ...
            <div className="mt-4 p-4 bg-white dark:bg-gray-800 rounded-lg">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                <strong>{'Calculation Formula'}:</strong> {'Net Salary'} = ({'Basic Salary'} + {'Allowances'}) - ({'Per Day Salary'} × {'Unpaid Leave Days'}) + {'Overtime'} - {'Deductions'}
              </p>
              <div className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                <p><strong>{'Unpaid Leave Days Breakdown'}:</strong></p>
