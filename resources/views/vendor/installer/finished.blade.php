    ...
    <div class="space-y-6 p-6 mt-6">
        @if (session('message')['dbOutputLog'])
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <pre class="bg-gray-800 text-primary-400 p-4 rounded text-sm overflow-x-auto"><code>{{ session('message')['dbOutputLog'] }}</code></pre>
            </div>
        @endif
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <pre class="bg-gray-800 text-primary-400 p-4 rounded text-sm overflow-x-auto"><code>{{ $finalMessages }}</code></pre>
        </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <pre class="bg-gray-800 text-primary-400 p-4 rounded text-sm overflow-x-auto"><code>{{ $finalStatusMessage }}</code></pre>
        </div>
