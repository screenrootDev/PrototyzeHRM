    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <div class="bg-gradient-to-br from-primary-50 to-primary-50 rounded-lg p-6 border border-primary-100 hover:shadow-lg transition-all duration-200">
            <div class="text-center">
                ...
                <a href="{{ route('LaravelInstaller::environmentWizard') }}" class="inline-flex items-center px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors duration-200 w-full justify-center">
