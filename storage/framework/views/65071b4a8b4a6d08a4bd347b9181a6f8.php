    ...
    <div class="text-center animate-slide-up">
        ...
        <div class="space-y-8">
            ...
            <div class="flex justify-center pt-4">
                <a href="<?php echo e(route('LaravelInstaller::requirements')); ?>" class="group relative inline-flex items-center px-10 py-4 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-2xl transition-all duration-300 shadow-lg shadow-primary-200 hover:shadow-primary-300 hover:-translate-y-1">
...
<?php echo $__env->make('vendor.installer.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/PrototyzeHRM/resources/views/vendor/installer/welcome.blade.php ENDPATH**/ ?>