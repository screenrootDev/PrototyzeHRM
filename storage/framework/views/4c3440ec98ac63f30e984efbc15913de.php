...
<?php $__env->startSection('title'); ?>
    <i class="fas fa-check-circle mr-2 text-primary-600"></i>
...
<?php $__env->startSection('container'); ?>
    ...
    <div class="bg-primary-50 border border-primary-100 rounded-lg p-6 mt-6">
        <h3 class="font-medium text-primary-900 mb-4 flex items-center">
    ...
    <div class="space-y-6 p-6 mt-6">
        <?php if(session('message')['dbOutputLog']): ?>
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <pre class="bg-gray-800 text-primary-400 p-4 rounded text-sm overflow-x-auto"><code><?php echo e(session('message')['dbOutputLog']); ?></code></pre>
            </div>
        <?php endif; ?>

        <div class="bg-gray-50 rounded-lg p-4">
            <h3 class="font-medium text-gray-900 mb-2 flex items-center">
                <i class="fas fa-terminal mr-2 text-primary-600"></i>
                <?php echo e(trans('installer_messages.final.console')); ?>

            </h3>
            <pre class="bg-gray-800 text-primary-400 p-4 rounded text-sm overflow-x-auto"><code><?php echo e($finalMessages); ?></code></pre>
        </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <pre class="bg-gray-800 text-primary-400 p-4 rounded text-sm overflow-x-auto"><code><?php echo e($finalStatusMessage); ?></code></pre>
        </div>
...
<?php echo $__env->make('vendor.installer.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/PrototyzeHRM/resources/views/vendor/installer/finished.blade.php ENDPATH**/ ?>