            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="app_name" id="app_name" value="" 
                           ...
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php echo e($errors->has('app_name') ? 'border-red-500' : ''); ?>" />
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex space-x-4">
                        <label class="flex items-center">
                            <input type="radio" name="app_debug" value="true" class="mr-2 text-primary-600" />
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_debug_label_true')); ?>

                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="app_debug" value="false" class="mr-2 text-primary-600" checked />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor.installer.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/PrototyzeHRM/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>