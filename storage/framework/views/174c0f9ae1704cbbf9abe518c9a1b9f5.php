...
<?php $__env->startSection('container'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <!-- Wizard Option -->
        <div class="bg-gradient-to-br from-primary-50 to-primary-50 rounded-lg p-6 border border-primary-100 hover:shadow-lg transition-all duration-200">
            <div class="text-center">
                ...
                <a href="<?php echo e(route('LaravelInstaller::environmentWizard')); ?>" class="inline-flex items-center px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors duration-200 w-full justify-center">
...
<?php echo $__env->make('vendor.installer.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/PrototyzeHRM/resources/views/vendor/installer/environment.blade.php ENDPATH**/ ?>