...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    // Test route for notifications (can be removed later)
    Route::get('/test-notification', function () {
        auth()->user()->notify(new \App\Notifications\TestNotification(
            'System Notification Test',
            'Hello! This is a test notification generated by visiting the test route. The system is fully operational!'
        ));
    ...
    Route::group([], function () { // Removed plan.access middleware
